            ...
            stage('Define Agent') {
                ...
                steps {
                    script {
                        ...
                        env.DOCKER_IMAGE = 'vyos/vyos-build:sagitta-apt-cache'
                        ...
                        env.DOCKER_ARGS = '-v vyos-apt-cache:/var/cache/apt --sysctl net.ipv6.conf.lo.disable_ipv6=0 -e GOSU_UID=' + env.USR_ID + ' -e GOSU_GID=' + env.GRP_ID
                    }
                }
            }
            stage('Build Code') {
